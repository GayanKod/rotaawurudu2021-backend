...
exports.registerController = (req, res) => {
    const { name, email, batch, faculty, house, password } = req.body;
    ...
    if (token) {
        jwt.verify(token, process.env.JWT_ACCOUNT_ACTIVATION, (err, decoded) => {
            if (err) {
                ...
                const { name, email, batch, faculty, house, password } = jwt.decode(token);
...
exports.signinController = (req, res) => {
    ...
    if (!errors.isEmpty()) {
        ...
        User.findOne({
            ...
            const { _id, name, email, batch, faculty, house } = user;
